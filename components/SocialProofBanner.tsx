  ...
  return (
    <div className="bg-gradient-to-r from-green-50 to-blue-50 border-b border-green-200">
      <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 py-1 sm:py-2">
        {/* Blog link - integrated into layout */}
        <div className="flex justify-end mb-1 sm:mb-2">
          <a href="/blog" className="px-2 sm:px-4 py-1 sm:py-1.5 rounded-lg bg-purple-100 text-purple-700 font-semibold hover:bg-purple-200 transition text-xs sm:text-sm">Read our Blog</a>
        </div>
        <div className="flex flex-col md:flex-row items-center justify-between space-y-1 sm:space-y-2 md:space-y-0 md:space-x-8">
          ...
          <motion.div 
            className="flex items-center space-x-2 sm:space-x-6 text-xs sm:text-sm text-muted-foreground"
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.6 }}
          >
